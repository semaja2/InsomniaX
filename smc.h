...
#define SMC_KEY_AMBIENT_AIR_0           "TA0P"
#define SMC_KEY_AMBIENT_AIR_1           "TA1P"
#define SMC_KEY_CPU_0_DIODE             "TC0D"
#define SMC_KEY_CPU_0_HEATSINK          "TC0H"
#define SMC_KEY_CPU_0_PROXIMITY         "TC0P"
