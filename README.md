...
- InsomniaX should have a clean and simple interface, if an option is not part of the core functionality then it should be made available via either an preference item accessible by command line or a "advanced/hidden" preference panel
...
For the time being this project is deemed to be "private code" and is not available for sharing, redistribution, inclusion in other works, also all liabilities are waived.

With that being said I am happy for people to contribute code changes, if anyone wants to fork the code they must include links to both this repo and the semaja2.net website as the orginal source.

## Uninstalling/Reparing Install
